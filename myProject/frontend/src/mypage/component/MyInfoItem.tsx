      ...
      <View style={[styles.viewContainer]}>
        <View style={[styles.topBar]}>
          <NavigationHeader
            title="내 정보"
            Left={() => (
              <Icon name="text-account" size={30} onPress={goSetting} />
            )}
            Right={() => (
              <Icon name="cart-heart" size={30} onPress={goShoppingCart} />
            )}
          />
        </View>
        ...
        <View style={[styles.contentView]}>
          <Text style={{fontSize: 23}}>
            주소: {loggedUser.memberMainAddr + loggedUser.memberDetailAddr}
          </Text>
          <Pressable
            style={[styles.pressAble]}
            onPress={() => {
