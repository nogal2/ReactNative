            ...
            (
              ...
              <TouchableOpacity
                ...
                <Image
                  ...
                  source={config.titleImageUri[goods.goodsSeq - 1]}></Image>

                <Text style={{fontSize: 20}}>{goods.goodsName}</Text>
                <Text style={{fontSize: 15}}>수량 : {goods.count}개</Text>
                <Text style={{fontSize: 15}}>
                  가격 : {parseInt(goods.goodsPrice) * parseInt(goods.count)}원
                </Text>
              </TouchableOpacity>
            ),
          )}
      ...
      {!loggedIn && (
        <View>
          ...
          <Button
            icon="login"
            mode="contained"
            onPress={() => navigation.navigate('MyNavigator' as never)}>
            로그인
          </Button>
        </View>
      )}
