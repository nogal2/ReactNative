...
const MyUploadedRecipeFlatList: FC<MyUploadedRecipeDatas> = ({
  datas: initialDatas,
}: any) => {
    ...
    <Pressable style={[styles.container]} onPress={goRecipeDetail}>
      <View style={[styles.leftView]}>
        <Image
          ...
          source={{uri: config.photo + myRecipe.recipeThumbnail}}
        />
      </View>
      <View style={[styles.rightView]}>
        ...
        <View style={{flexDirection: 'row'}}>
          ...
          <View style={[styles.ratingCount]}>
            <Text style={{fontSize: 18, color: Colors.grey500}}>
              ({myRecipe.recipeRating})
            </Text>
          </View>
          <View style={[styles.readCount]}>
            <Text style={{fontSize: 18, color: Colors.grey500}}>
              조회수 {myRecipe.recipeReadcount}회
            </Text>
          </View>
        </View>
      </View>
