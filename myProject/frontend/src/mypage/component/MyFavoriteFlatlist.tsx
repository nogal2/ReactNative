...
const MyFavoriteFlatlist: FC<MyFavoriteRecipeDatas> = ({
  datas: initialDatas,
}) => {
    ...
    <View style={[styles.container]}>
      <View style={[styles.leftView]}>
        <Image
          ...
          source={{uri: config.photo + myRecipe.thumbnailList}}
        />
      </View>
        ...
        <View style={{flexDirection: 'row'}}>
          ...
          <View style={[styles.ratingCount]}>
            <Text style={{fontSize: 18, color: Colors.grey500}}>
              ({myRecipe.recipeRatingCountList})
            </Text>
          </View>
          <View style={[styles.readCount]}>
            <Text style={{fontSize: 18, color: Colors.grey500}}>
              {' '}
              {myRecipe.recipeRatingList}점
            </Text>
          </View>
        </View>
      </View>
