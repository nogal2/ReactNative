import React, { forwardRef, ForwardRefRenderFunction, MutableRefObject, ReactNode, useImperativeHandle, useState } from "react";
import { FlatList, Platform, StyleSheet, Animated, View } from "react-native";
...
const styles = StyleSheet.create({
    view: {
        width:'100%', flex:1, backgroundColor: Platform.select({ios:undefined, android: 'transparent'})
    }
})